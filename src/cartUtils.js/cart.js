                  ...
                  {cartItems.map((item) => (
                    <li key={item.id} className="flex items-center justify-between">
                      ...
                      <button 
                        ...
                        className="px-3 py-1 bg-[#E10075] red-500 text-white text-sm font-medium rounded hover:bg-[#E10075] red-600 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-opacity-50"
                      >
                        Remove
                      </button>
                    </li>
